...
public class AccessibleOrbitViewInputSupport extends OrbitViewInputSupport
{
	...
	public static AccessibleOrbitViewState computeOrbitViewState(Globe globe, Vec4 eyePoint,
			Vec4 centerPoint, Vec4 up)
	{
		OrbitViewState ovs =
				OrbitViewInputSupport.computeOrbitViewState(globe, eyePoint, centerPoint, up);
		return new AccessibleOrbitViewState(ovs.getCenterPosition(), ovs.getHeading(),
				ovs.getPitch(), ovs.getZoom());
	}
}
