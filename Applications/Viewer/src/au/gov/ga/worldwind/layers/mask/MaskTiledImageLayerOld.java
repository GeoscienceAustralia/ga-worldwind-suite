...
public class MaskTiledImageLayerOld extends TiledImageLayer
{
	...
	public MaskTiledImageLayerOld(LevelSet levelSet)
	{
		super(levelSet);
	}
	...
	{
		private final MaskTiledImageLayerOld layer;
		private final TextureTile tile;

		private RequestTask(TextureTile tile, MaskTiledImageLayerOld layer)
		{
			this.layer = layer;
			this.tile = tile;
		}
			...
			RetrievalPostProcessor
	{
		...
		public DownloadPostProcessor(TextureTile tile, MaskTiledImageLayerOld layer)
		{
			this.tile = tile;
			this.layer = layer;
		}
