...
public class CollapsibleGroupLAF
{
	public static void init()
	{
		...
		UIManager.put(CollapsibleGroup.UI_CLASS_ID,
				GlossyCollapsibleGroupUI.class.getCanonicalName());
		...
		UIManager.put("TaskPaneGroup.background", new ColorUIResource(245, 245,
				245));
		UIManager.put("TaskPaneGroup.titleForeground", new ColorUIResource(
				Color.black));
		UIManager.put("TaskPaneGroup.specialTitleBackground",
		...
		UIManager.put("TaskPaneGroup.titleBackgroundGradientEnd",
				new ColorUIResource(188, 188, 188));
		UIManager.put("TaskPaneGroup.borderColor", new ColorUIResource(97, 97,
				97));
		UIManager.put("TaskPaneGroup.titleOver", new ColorUIResource(125, 125,
				97));
		UIManager.put("TaskPaneGroup.specialTitleOver", new ColorUIResource(
				125, 125, 97));
	}
}
