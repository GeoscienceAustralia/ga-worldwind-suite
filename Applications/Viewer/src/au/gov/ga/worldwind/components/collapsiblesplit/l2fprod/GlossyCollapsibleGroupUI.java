...
/**
 * Paints the CollapsibleGroup with a gradient in the title bar.
 */
public class GlossyCollapsibleGroupUI extends CollapsibleGroupUI
{
	...
	class GlossyPaneBorder extends PaneBorder
	{
		...
		protected void paintTitleBackground(CollapsibleGroup group, Graphics g)
		{
			...
			g.fillRoundRect(0, 0, group.getWidth() - 1, ROUND_HEIGHT * 2,
