...
/**
 * A {@link RetrievalService} that blocks on calls to {@link #runRetriever(Retriever)},
 * returning only when retrieval has completed.
 * <p/>
...
public class ImmediateRetrievalService implements RetrievalService
{
	...
	{
		RetrievalFuture future = delegate.runRetriever(retriever, priority);
