		...
		Tessellator
{
	protected static class RenderInfo
	{
		...
		private RenderInfo(int density, DoubleBuffer vertices,
				DoubleBuffer texCoords, Vec4 refCenter, int resolution)
		{
	...
	private static final double DEFAULT_LOG10_RESOLUTION_TARGET = 1.2;
	...
	private static final String CACHE_ID = ConfigurableTessellator.class
			.getName();
	...
	private double log10ResolutionTarget = DEFAULT_LOG10_RESOLUTION_TARGET;
			...
			boolean makeSkirts)
	{
		...
		return new RenderInfo(density, verts, getTextureCoordinates(density),
				refCenter, elevations.getResolution());
	}
