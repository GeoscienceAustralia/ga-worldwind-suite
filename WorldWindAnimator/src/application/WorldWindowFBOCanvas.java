 ...
 * displaying World Wind {@link Model}s (globe and layers). It's a
 * self-contained component intended to serve as an application's world window.
 * rendering.
 * 
 * @author Tom Gaskins
 * @version $Id: WorldWindowGLCanvas.java 7649 2008-11-15 07:11:30Z tgaskins $
 */
public class WorldWindowFBOCanvas extends FBOCanvas implements WorldWindow,
		PropertyChangeListener
{
	...
	/**
	 * Constructs a new <code>WorldWindowGLCanvas</code> window on the default
	 * graphics device that will share graphics resources with another
	 * <code>WorldWindowGLCanvas</code> window. The other window,
	 * <code>sharewith</code>, may not be null
	 * 
	 * @param shareWith
	 *            a <code>WorldWindowGLCanvas</code> with which to share
	 *            graphics resources.
	 * 
	 ...
	 */
	public WorldWindowFBOCanvas(WorldWindowFBOCanvas shareWith)
	{
	...
	/**
	 * Constructs a new <code>WorldWindowGLCanvas</code> window that will share
	 * graphics resources with another <code>WorldWindowGLCanvas</code> window.
	 * The new window is created on the specified graphics device. Neither
	 ...
	 *            graphics resources.
	 * @param device
	 *            the <code>GraphicsDevice</code> on which to create the window.
	 * 
	 * @throws NullPointerException
	 *             if <code>shareWith</code> is null.
	 * @throws IllegalArgumentException
	 *             if <code>deevice</code> is null.
	 * @see GLCanvas#GLCanvas(GLCapabilities,GLCapabilitiesChooser,GLContext,GraphicsDevice)
	 */
	public WorldWindowFBOCanvas(WorldWindowFBOCanvas shareWith,
