 ...
 */
public class ItemRemovedMessage implements ItemMessage<ItemRemovedMessage>
{
	/**
	 * @see #getModelId()
	 */
	...
	/**
	 * Index path in the tree where the item existed before being removed.
	 */
	public final int[] treeIndexPath;

	@SuppressWarnings("unused")
	private ItemRemovedMessage()
	{
		this(-1, null);
	}

	public ItemRemovedMessage(int modelId, int[] treeIndexPath)
	{
	...
	@Override
	public ItemRemovedMessage fromBytes(ByteBuffer buffer)
	{
		...
		return new ItemRemovedMessage(modelId, treeIndexPath);
	}

	@Override
	public MessageId getId()
	{
		return MessageId.ITEM_REMOVED;
	}
