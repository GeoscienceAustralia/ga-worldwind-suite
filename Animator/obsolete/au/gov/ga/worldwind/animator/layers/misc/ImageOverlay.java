...
public class ImageOverlay extends AbstractLayer
{
	...
	private String resizeBehavior = AVKey.RESIZE_STRETCH;
	...
	public ImageOverlay(String iconFilePath)
	{
	 ...
	 * viewport size changes, typically when the World Wind window is resized.
	 * If the value is AVKey.RESIZE_KEEP_FIXED_SIZE, the icon size is kept to
	 * the size specified in its image file scaled by the layer's current icon
