...
/**
 * {@link SharedLockBasicElevationModel} subclass that requests tiles immediately when
 * {@link ImmediateMode} is enabled.
 * 
 * @author Michael de Hoog (michael.dehoog@ga.gov.au)
 */
public class ImmediateSharedLockBasicElevationModel extends SharedLockBasicElevationModel
{
	private boolean requestingTile;
	
	public ImmediateSharedLockBasicElevationModel(AVList params)
	{
		super(params);
	}

	public ImmediateSharedLockBasicElevationModel(Element domElement, AVList params)
	{
