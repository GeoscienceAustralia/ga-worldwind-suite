 ...
 */
public class ImmediateMercatorImageURLRequesterDelegate extends MercatorImageURLRequesterDelegate
{
	@Override
	...
	public IDelegate fromDefinition(String definition, Element layerElement, AVList params)
	{
		if (definition.equalsIgnoreCase(DEFINITION_STRING))
			return new ImmediateMercatorImageURLRequesterDelegate();
		return null;
	}
}
