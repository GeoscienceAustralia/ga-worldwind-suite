	...
	<body>
		...
		<ol>
			<li>
				...
				Ensure that the check box in the <span class="UIElementReference">Layers panel</span> are next 
				to the layer name is checked. 
			</li>
			<li>
				...
				Ensure that the opacity of your layer is greater than 0%. This can be controlled using the <a href="Layers.jsp#layerOpacity">opacity 
				slider</a> in the <span class="UIElementReference">Layers panel</span>.
			</li>
			<li>
