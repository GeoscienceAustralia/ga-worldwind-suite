 ...
 *          tgaskins $
 */
public class TransparentMercatorTiledImageLayer extends MercatorTiledImageLayer
{
	private final Object fileLock = new Object();

	public TransparentMercatorTiledImageLayer(LevelSet levelSet)
	{
		super(levelSet);
	...
	public TransparentMercatorTiledImageLayer(AVList params)
	{
	...
	{
		final URL textureURL = this.getDataFileStore().findFile(tile.getPath(),
				true);
	...
	{
		private final TransparentMercatorTiledImageLayer layer;
		private final MercatorTextureTile tile;

		private RequestTask(MercatorTextureTile tile,
				TransparentMercatorTiledImageLayer layer)
		{
			this.layer = layer;
			this.tile = tile;
		}
	...
	private boolean transformAndSave(BufferedImage image,
			MercatorSector sector, File outFile)
	{
		try
		{
