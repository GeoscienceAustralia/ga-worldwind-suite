...
public class PotassiumLayer extends MaskTiledImageLayer
{
	...
	private static LevelSet makeLevels()
	{
		...
		params.setValue(AVKey.DATA_CACHE_NAME, "GA/Radiometrics/K_100m_he_rgb");
		params.setValue(AVKey.SERVICE,
				"http://sandpit:8500/map/web3d/worldwind/scripts/tiles.php");
		params.setValue(AVKey.DATASET_NAME, "radio_K_100m_he_rgb");
		...
		params.setValue(AVKey.TILE_URL_BUILDER, MaskTiledImageLayer
				.createDefaultUrlBuilder("tiles/K_100m_he_rgb",
