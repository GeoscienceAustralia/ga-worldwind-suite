...
public class RatioUThLayer extends MaskTiledImageLayer
{
	...
	private static LevelSet makeLevels()
	{
		...
		params.setValue(AVKey.DATA_CACHE_NAME, "GA/Radiometry/ratio_ut_100m_he_rgb");
		params.setValue(AVKey.SERVICE, "http://localhost/wwtiles/radio.php");
		params.setValue(AVKey.DATASET_NAME, "ratio_ut_100m_he_rgb");
	...
	{
		return "GA Radiometry - Uranium Thorium Ratio";
	}
}
