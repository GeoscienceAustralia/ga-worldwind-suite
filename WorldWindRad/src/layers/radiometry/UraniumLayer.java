...
public class UraniumLayer extends MaskTiledImageLayer
{
	public UraniumLayer()
	{
		super(makeLevels());
	...
	private static LevelSet makeLevels()
	{
		...
		params.setValue(AVKey.DATA_CACHE_NAME, "GA/Radiometrics/U_100m_he_rgb");
		params.setValue(AVKey.SERVICE,
				"http://sandpit:8500/map/web3d/worldwind/scripts/tiles.php");
		params.setValue(AVKey.DATASET_NAME, "radio_U_100m_he_rgb");
		...
		params.setValue(AVKey.TILE_URL_BUILDER, MaskTiledImageLayer
				.createDefaultUrlBuilder("tiles/U_100m_he_rgb",
