...

{
	private static final Logger logger = Logger
			.getLogger(QuadKeyEarthTile.class.getName());
	 ...
	 *            Image url
	 * @param cacheRoot
	 *            WW tile cache location
	 */
	public QuadKeyEarthTile(String tileKey, final String tileURL,
	...
	public static class DownloadPostProcessor implements RetrievalPostProcessor
	{
		...
		public DownloadPostProcessor(File outFile, Object lock)
		{
		...
		public ByteBuffer run(Retriever retriever)
		{
			...
			{
				logger.severe("Retriever failed  w/ state:"
						+ retriever.getState());
				return null;
			}
			...
			if (retriever instanceof HTTPRetriever)
			{
				...
				{
					logger.severe("Download failed: " + htr.getResponseCode()
							+ " " + htr.getResponseMessage() + " url: "
							+ htr.getUrl());
			...
			throws MalformedURLException
	{
		Retriever retriever = new HTTPRetriever(new URL(url),
				new DownloadPostProcessor(file, lock));
