...
/**
 * @author tag
 * @version $Id: AWTInputHandler.java 9558 2009-03-20 03:40:36Z dcollins $
 */
    ...
    Disposable
{
    ...
    {
        this.viewInputHandler.setLockHeading(lockHeading);
    }
    ...
    {
        this.viewInputHandler.setStopOnFocusLost(stopView);
    }
