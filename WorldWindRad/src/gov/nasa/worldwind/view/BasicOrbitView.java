...
public class BasicOrbitView extends AbstractView implements OrbitView
{
    ...
    protected double nearClipDistance = -1; // Default to auto-configure.
    protected double farClipDistance = -1;  // Default to auto-configure.
    // Model for defining translations between OrbitView coordinates and 3D coordinates.
    protected final OrbitViewModel orbitViewModel;
