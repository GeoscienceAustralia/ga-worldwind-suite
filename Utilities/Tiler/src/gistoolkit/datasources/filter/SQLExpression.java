 ...
 */
public class SQLExpression extends Expression implements SQLFilter{
    ...
    public SQLExpression(SQLFilter inFilter1, int inComparison, SQLFilter inFilter2){
    ...
    public String getFilterSQL(SQLConverter inSQLConverter) {
        ...
        if ((tempFilter1SQL == null) || (tempFilter1SQL.length() == 0)){
            if ((tempFilter2SQL == null) || (tempFilter2SQL.length() == 0)){
                System.out.println("SQLExpression, No SQL from either filter");
                return "";
            }
            System.out.println("SQLExpression, filter2sql="+tempFilter2SQL);
            return tempFilter2SQL;
        }
        else if ((tempFilter2SQL == null) || (tempFilter2SQL.length() == 0)){
            System.out.println("SQLExpression, filter1sql="+tempFilter1SQL);            
