...
public class Expression implements Filter{
    ...
    private String myFilterName = "Expression";
     ...
     */
    public Node getNode() {
        Node tempRoot = new Node("Expression");
    ...
    public void setNode(Node inNode) throws Exception {
        if (inNode != null){
            ...
            if (tempNode == null) throw new Exception ("Expression "+getFilterName()+" must have two filters, "+FILTER1_NODE+" is missing");
            else{
                String tempClassName = tempNode.getAttribute(FILTER_CLASS);
                if (tempClassName == null) throw new Exception("Expression "+getFilterName()+" must have a class for filter 1");
            ...
            if (tempNode == null) throw new Exception ("Expression "+getFilterName()+" must have two filters, "+FILTER2_NODE+" is missing");
            else{
                String tempClassName = tempNode.getAttribute(FILTER_CLASS);
                if (tempClassName == null) throw new Exception("Expression "+getFilterName()+" must have a class for filter 2");
